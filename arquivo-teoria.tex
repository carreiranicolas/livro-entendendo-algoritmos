...
\begin{document}
	...
	Agora, vamos analisar o tempo de execução disso. Para encontrar o artista com maior número de plays, você precisaria verificar cada item da lista. Isso tem tempo de execução de O(n), sendo assim, temos uma operação com o tempo de execução de O(n) que precisa ser repetida n vezes \\ 
