...
\begin{document}
	...
	Cada vez que você precisa armazenar um item na memória, você pede ao computador espaço e ele te dá um endereço onde você pode armazenar aquele item. Se você quiser armazenar múltiplos itens, poderá fazer de duas maneiras: utilizando arrays e listas
